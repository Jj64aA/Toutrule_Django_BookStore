...
class Customer(models.Model):
    ...
    avatar = models.ImageField(blank=True,null=True,default="user.png")
...
class Book(models.Model):
    ...
    avatar = models.ImageField(blank=True,null=True,default="book-def.jpg") #,upload_to='static/images'
